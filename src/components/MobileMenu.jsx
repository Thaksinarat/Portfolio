...
export const MobileMenu = ({ menuOpen, setMenuOpen }) => {
    return <>
        <div className={`fixed top-0 left-0 w-full bg-black/80 z-40 flex flex-col items-center justify-center
                ...
                : "h-0 opacity-0 pointer-evnets-none"
            }
            `}>
            ...
            <a href="#Artwork" onClick={() => {setMenuOpen(false)}} className={`text-2xl font-semibold text-white my-4 transform transition-transform duration-300 ${menuOpen ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}>Artworks</a>
